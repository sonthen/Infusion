          ...
          <div class="col-md-5">
            <div class="row">
                <div class="col-md-offset-1 col-md-11 email-title">
                    ...
                    <span>                        <a class="logout-btn" href="<?php echo base_url(); ?>/authCont/logout">Logout</a>
</span>
                    <div>
                        <span>  <a href="<?php echo base_url(); ?>userCont/addEmailCampaign">
          ...
          <div class="col-md-5 col-md-offset-1">
              <div class="row">
                  <div class="col-md-offset-1 col-md-11">
                      ...
                      <span><a href="<?php echo base_url(); ?>userCont/addSmsCampaign"><button type="button" class="w3-button w3-xlarge w3-circle  btn-plus2">+</button></a></span>
                  </div>
              </div>
          </div>
